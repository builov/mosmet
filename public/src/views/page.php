                    ...
                    <div class="contact-navigation-inner">
                        <ul class="top-menu">
                            <li class="menu-item menu-item-type-post_type menu-item-object-page">
                                <a href="mailto:info@vertolet.company" aria-current="page">
                                    <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                    <span class="desktop-only">info@vertolet.company</span>
                                </a>
                            </li>
                            <li class="menu-item menu-item-type-post_type menu-item-object-page">
                            ...
                            <li>
                                <a class="icon" href="https://api.whatsapp.com/send?phone=79153477071" target="_blank">
                                        <img class="fa fa-whatsapp" src="img/WhatsApp.svg" height="30" width="30" />
<!--                                    <i class="fa fa-whatsapp" aria-hidden="true"></i>-->
                                </a>

                                <a class="icon" href="https://t.me/VERTOLET_sale" target="_blank">
                                        <img class="fa fa-telegram" src="img/Telegram.svg" height="27" width="27" />
<!--                                    <i class="fa fa-telegram" aria-hidden="true"></i>-->
                                </a>

                                <a class="icon" href="viber://chat?number=%2B79153477071" target="_blank">
                                        <img class="fa fa-brands fa-viber" src="img/Viber2.svg" height="26" width="26" />
                        ...
                        <section class="elementor-element elementor-element-bdc61ec elementor-section-height-min-height elementor-section-content-middle elementor-section-boxed elementor-section-height-default elementor-section-items-middle elementor-section elementor-top-section" data-id="bdc61ec" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                            ...
                            <div class="elementor-background-overlay">
                                <video muted="muted" loop autoplay="autoplay">
                                    <source src="out5.mp4" type="video/mp4">
                                            ...
                                            <div class="elementor-widget-wrap">
                                                ...
                                                <div class="elementor-element elementor-element-694ed43b elementor-widget elementor-widget-button" data-id="694ed43b" data-element_type="widget" data-widget_type="button.default">
                                                    <div class="elementor-widget-container">
                                                        ...
                                                        <img class="brand-logo" src="img/brands/rapid_tools_logo.svg" style="width: 220px;" />
                                                        <img class="brand-logo" src="img/brands/olfa.png" style="width: 220px;margin-bottom: 65px;" />
                                        ...
                                        <div class="elementor-column-wrap  elementor-element-populated">
                                            ...
                                            <div class="elementor-widget-wrap">
                                                ...
                                                <div class="elementor-element elementor-element-f223197 elementor-widget elementor-widget-text-editor" data-id="f223197" data-element_type="widget" data-widget_type="text-editor.default">
                                                    <div class="elementor-widget-container">
                                                        <div class="elementor-text-editor elementor-clearfix">Вертолеты в пробках не стоят.</div>
                                                    </div>
                                                </div>
                                                <div class="elementor-element elementor-element-1dc591b elementor-widget elementor-widget-text-editor" data-id="1dc591b" data-element_type="widget" data-widget_type="text-editor.default">
                                                    <div class="elementor-widget-container">
                                                        <div class="elementor-text-editor elementor-clearfix">Народная мудрость</div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        <div class="elementor-text-editor elementor-clearfix">
                                                            <p>ООО &laquo;ВЕРТОЛЁТ&raquo;<br />
                                                                ...
                                                                E-mail: <a href="mailto:info@vertolet.company">info@vertolet.company</a><br />
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        <div class="elementor-social-icons-wrapper">
                                                            ...
                                                            <a class="elementor-icon elementor-social-icon icon-telegram"
                                                               href="https://t.me/VERTOLET_sale" target="_blank">
